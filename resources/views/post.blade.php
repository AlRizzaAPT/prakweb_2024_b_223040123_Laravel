                        ...
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                ...
                                <a href="/posts?category={{ $post->category->slug }}">
                                    <span class="text-black text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:text-primary-800" style="background-color: {{ $post->category->color }};">
                                        {{ $post->category->name }}
                                    </span>
                                </a>
                            </div>
